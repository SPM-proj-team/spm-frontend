		...
		<div class="card-body">
			...
			<div class="form-floating mb-3">
				<textarea
					...
					class="form-control"
					style="height: 150px; max-height: 200px; min-height: 200px"
			...
			<div class="row mb-3" v-if="formType == 'create'">
				<div class="col-12">
					<button
						type="reset"
						class="btn btn-primary btn-lg shadow w-100 fw-semibold"
			...
			<div class="row" v-if="formType == 'update'">
				<div class="col-12 col-lg-6 mb-3">
					<button
						type="button"
						class="btn btn-danger btn-lg shadow w-100 fw-semibold"
						id="delete-btn"
				...
				<div class="col-12 col-lg-6 mb-3">
					<button
						type="button"
						class="btn btn-primary btn-lg shadow w-100 fw-semibold"
						@click="$emit('updateLearningJourney')"
					>
						Update
					</button>
				</div>
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button
							...
							data-bs-dismiss="modal"
							id="delete-modal-btn"
							@click="$emit('deleteLearningJourney')"
						>
							Delete
						</button>
					</div>
